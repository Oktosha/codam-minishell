...
/*   Updated: 2023/08/21 13:56:07 by evoronin      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_lx_node_lx_token_ptr
{
	t_lx_token						*token;
	struct s_lx_node_lx_token_ptr	*next;
}	t_lx_node_lx_token_ptr;

typedef struct s_lx_so_far
{
	t_lx_node_lx_token_ptr	*head;
	t_lx_token				token;
	t_lx_status				status;
	t_lx_state				state;
}	t_lx_so_far;
